...
foreach my $filebam (@ARGV){
  ...
  for (my $q=10;$q<=50;$q+=20) {
	...
	"if [ -e ".$outprefix."_".$type."_final_endo.log ];  then  tail -n+2 ".$outprefix."_".$type."_final_endo.log |cut -f 6| awk 'BEGIN{sum=0;}{ sum+=\$\$1; }END{print sum/NR}'  > ".$outprefix."_".$type."_final_endo.cov; ".$installDir."//log2fasta -name ".$name."q10w -q ".$q." -indel ".$q." ".$outprefix."_".$type."_final_endo.log > ".$outprefix."_".$type."_final_endo.q".$q.".fa; else ".
        "if [ -e ".$outprefix."_".$type."_5_endo.log ];  then  tail -n+2 ".$outprefix."_".$type."_5_endo.log |cut -f 6| awk 'BEGIN{sum=0;}{ sum+=\$\$1; }END{print sum/NR}'  > ".$outprefix."_".$type."_final_endo.cov; ".$installDir."/log2fasta -name ".$name."q10w -q ".$q." -indel ".$q." ".$outprefix."_".$type."_5_endo.log > ".$outprefix."_".$type."_final_endo.q".$q.".fa; else ".
        "if [ -e ".$outprefix."_".$type."_4_endo.log ];  then  tail -n+2 ".$outprefix."_".$type."_4_endo.log |cut -f 6| awk 'BEGIN{sum=0;}{ sum+=\$\$1; }END{print sum/NR}'  > ".$outprefix."_".$type."_final_endo.cov; ".$installDir."/log2fasta -name ".$name."q10w -q ".$q." -indel ".$q." ".$outprefix."_".$type."_4_endo.log > ".$outprefix."_".$type."_final_endo.q".$q.".fa; else ".
	"if [ -e ".$outprefix."_".$type."_3_endo.log ];  then tail -n+2 ".$outprefix."_".$type."_3_endo.log |cut -f 6| awk 'BEGIN{sum=0;}{ sum+=\$\$1; }END{print sum/NR}'  > ".$outprefix."_".$type."_final_endo.cov;  ".$installDir."/log2fasta -name ".$name."q10w -q ".$q." -indel ".$q." ".$outprefix."_".$type."_3_endo.log > ".$outprefix."_".$type."_final_endo.q".$q.".fa; else ".
        "if [ -e ".$outprefix."_".$type."_2_endo.log ];  then tail -n+2 ".$outprefix."_".$type."_2_endo.log |cut -f 6| awk 'BEGIN{sum=0;}{ sum+=\$\$1; }END{print sum/NR}'  > ".$outprefix."_".$type."_final_endo.cov; ".$installDir."/log2fasta -name ".$name."q10w -q ".$q." -indel ".$q." ".$outprefix."_".$type."_2_final_endo.log > ".$outprefix."_".$type."_final_endo.q".$q.".fa; else ".
        "if [ -e ".$outprefix."_".$type."_1_endo.log ];  then tail -n+2 ".$outprefix."_".$type."_1_endo.log |cut -f 6| awk 'BEGIN{sum=0;}{ sum+=\$\$1; }END{print sum/NR}'  > ".$outprefix."_".$type."_final_endo.cov; ".$installDir."/log2fasta -name ".$name."q10w -q ".$q." -indel ".$q." ".$outprefix."_".$type."_1_endo.log > ".$outprefix."_".$type."_final_endo.q".$q.".fa; else echo \"error\"; fi; fi; fi; fi; fi; fi;\n\n";
    }
  }
