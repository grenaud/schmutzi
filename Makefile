...
install: all
	cp -fv src/posteriorDeam.R src/approxDist.R src/schmutzi.pl src/endoCaller src/mtCont src/damage2profile src/log2freq src/log2fasta src/contDeam src/msa2freq src/bam2prof src/insertSize src/logs2pos src/countRecords  src/jointFreqDeaminated src/jointFreqDeaminatedDouble src/msa2log src/log2ConsensusLog src/logdiff src/logmask src/filterlog src/msa2singlefreq src/subSampleBAM src/addXACircular /usr/bin/
...
clean :
	...
	rm -fv /usr/bin/posteriorDeam.R /usr/bin/approxDist.R /usr/bin/schmutzi.pl  /usr/bin/endoCaller /usr/bin/mtCont /usr/bin/damage2profile /usr/bin/log2freq /usr/bin/log2fasta /usr/bin/contDeam /usr/bin/msa2freq /usr/bin/bam2prof /usr/bin/insertSize /usr/bin/logs2pos /usr/bin/countRecords /usr/bin/jointFreqDeaminated /usr/bin/jointFreqDeaminatedDouble /usr/bin/msa2log /usr/bin/log2ConsensusLog /usr/bin/logdiff /usr/bin/logmask /usr/bin/filterlog /usr/bin/msa2singlefreq /usr/bin/subSampleBAM /usr/bin/addXACircular 
